...
import ReferralHeader from '../../../components/Header/ReferralHeader/ReferYourFriends';
            ...
            >
                ...
                <View style={styles.Tablecontainer}>
                    ...
                    <View style={styles.showDetailsButtonContainer}>
                        <TouchableOpacity
                            onPress={() => navigation.navigate(SCREENS.REFERRALEARNING)}
                ...
                <Text style={[styles.headerText, { marginTop: 30 }]}>Referral Network</Text>

                <ScrollView
                    horizontal
                    showsHorizontalScrollIndicator={false}
                    contentContainerStyle={styles.referralNetworkContainer}
                >
                    {[
                        { name: 'Ram', image: require('../../../assets/images/ReferralScreen/kirti.png') },
                        { name: 'Raj', image: require('../../../assets/images/ReferralScreen/Raj.png') },
                        { name: 'Soni', image: require('../../../assets/images/ReferralScreen/soni.png') },
                        { name: 'Jennie', image: require('../../../assets/images/ReferralScreen/Ram.png') },
                        { name: 'Soni', image: require('../../../assets/images/ReferralScreen/soni.png') },
                        { name: 'Jennie', image: require('../../../assets/images/ReferralScreen/Ram.png') },
                    ].map((user, index) => (
                        <View key={index} style={styles.referralUserContainer}>
